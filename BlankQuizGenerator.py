...
try:
    os.makedirs(quizzes)
    print("quizzes folder successfully created!")
except:
    print("Folders Already Exist!")
try:
    os.makedirs(answers)
    print("answers folder succssfully created!")
except:
    print("answers folder already exists")
...
for quizNum in range(35):
    ...
    with open(quiz_name, "w") as quiz_file, open(answer_name, "w") as answer_file:
        ...
        for value in quiz_order:
            ...
            quiz_file.write("Enter your answer here: ")
            quiz_file.write("\n\n")
